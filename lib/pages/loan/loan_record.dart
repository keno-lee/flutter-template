...
class LoanRecordPage extends StatefulWidget {
  @override
  _LoanRecordPageState createState() => _LoanRecordPageState();
}

class _LoanRecordPageState extends State<LoanRecordPage> {
  @override
