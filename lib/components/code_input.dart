...
//         underlinePaint.strokeWidth = ScreenUtil().setWidth(1);
//       } else {
//         underlinePaint.color = dr.color;
//         underlinePaint.strokeWidth = ScreenUtil().setWidth(0.5);
//       }
...
//     ///画光标  如果外部有传，则直接使用外部
//     Color cursorColor =
//         dr.enteredColor != null ? dr.enteredColor : Color(0xff3776E9);
//     cursorColor = cursorColor.withAlpha(alpha);

//     double cursorWidth = ScreenUtil().setWidth(1);
//     double cursorHeight = ScreenUtil().setWidth(24);
...
//     this.gapSpace = 15.0,
//     this.color = const Color(0xff240000),
//     this.lineHeight = 0.5,
//   }) : super(
//           textStyle: textStyle,
//           obscureStyle: obscureStyle,
...
class UnderlineDecoration extends CodeDecoration {
  ...
  const UnderlineDecoration({
    TextStyle textStyle,
    ObscureStyle obscureStyle,
    this.enteredColor: const Color(0xff333333),
    this.gapSpace: 16.0,
...
class _CodePaint extends CustomPainter {
  ...
  _drawUnderLine(Canvas canvas, Size size) {
    ...
    if (text.length < codeLength) {
      Color cursorColor = Color(0xff333333);
